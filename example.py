...
bot = InstaBot(
    ...
    tag_list=['follow4follow', 'f4f', 'followme', 'cute', 'fujixt2',
              ...
              'exclusive_shots', 'hubs_united', 'jaw_dropping_shotz', 'worldshotz',
              'theworldshotz', 'pixel_ig', 'photographyislifee', 'photographyislife',
              'photographysouls', 'photographyeveryday', 'photographylover',
              'worldbestgram', 'iglobal_photographers', 'ig_great_pics',
              'ig_myshot', 'shotwithlove', 'justgoshoot', 'xposuremag',
              'icatching', 'collectivelycreate', 'wanderlust', 'heatercentral',
              'highsnobiety', 'shotzdelight'],
